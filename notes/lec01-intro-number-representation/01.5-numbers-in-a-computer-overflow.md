...
![image-20240527103115418](.image/image-20240527103115418.png)
...
- Unsigned: 0b1…1 + 1~10~ = 0b0…0 = 0?
- 2's: 0b01…1 + 1~10~ = 0b10…0 = -2(n-1)~ten~?

可以看到，结果会绕回来

![image-20240527103239979](.image/image-20240527103239979.png)
