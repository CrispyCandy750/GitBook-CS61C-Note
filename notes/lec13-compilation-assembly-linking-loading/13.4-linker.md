...
![image-20240609095422642](.image/image-20240609095422642.png)
...
![image-20240609095648624](.image/image-20240609095648624.png)

I-,S- Format: Loads and stores to variables in static area, relative to global pointer

![image-20240609095707905](.image/image-20240609095707905.png)

> 如果lw和sw都是要基于某个源寄存器的，如果这个源寄存器是global pointer，那么就需要relocate

What about conditional branches?

![image-20240609095727865](.image/image-20240609095727865.png)
