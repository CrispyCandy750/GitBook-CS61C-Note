...
![image-20240703114412090](.image/image-20240703114412090.png)
...
![Annualized hard-drive failure rates](.image/image-20240707094305511.png)

- 这些驱动器的AFR都很好，基本都为个位数甚至小于个位数，大约相当于1m或者100m小时的MTTF

还有，驱动器的故障率实际上随着时间在下降，故障率逐渐减少

![image-20240707094435047](.image/image-20240707094435047.png)
