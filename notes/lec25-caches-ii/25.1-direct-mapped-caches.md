...
![image-20240622194144324](.image/image-20240622194144324.png)
...
![image-20240622195654168](.image/image-20240622195654168.png)
...
![image-20240622202140083](.image/image-20240622202140083.png)

- Memory的每行中，地址较小的在右边，地址较大的在左边，地址的叠加顺序如下

    ![image-20240622202643528](.image/image-20240622202643528.png)
...
![image-20240621203931412](.image/image-20240621203931412.png)
...
![image-20240622210413563](.image/image-20240622210413563.png)

> 在Cache中是需要保存对应的Cache#的，但是取数据的时候不取那块，所以也不会算在Block中

What should go in the tag? 使用Memory的地址是可行的，如下

![image-20240622210509699](.image/image-20240622210509699.png)
...
![image-20240622214323283](.image/image-20240622214323283.png)
...
![image-20240621204215484](.image/image-20240621204215484.png)
...
![image-20240621204616262](.image/image-20240621204616262.png)
...
- Cache的大小B = 2^(H+W)^ = 2^H^*2^W^，H是Index的位数，W是Offset的位数
