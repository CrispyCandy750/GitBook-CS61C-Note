...
![image-20240615143810929](.image/image-20240615143810929.png)
...
![image-20240615144050114](.image/image-20240615144050114.png)
...
![image-20240615144131271](.image/image-20240615144131271.png)
...
![image-20240615144251495](.image/image-20240615144251495.png)
...
![image-20240615144324392](.image/image-20240615144324392.png)
...
![image-20240607203033238](../lec12-risc-v-instruction-formats-ii/.image/image-20240607203033238.png)
...
![image-20240616142333595](.image/image-20240616142333595.png)

然后我们将获取该指令，并且指令将地址指向寄存器文件中的相应字段，PC也被传到应该用到的地方。

![image-20240616142343762](.image/image-20240616142343762.png)
...
![image-20240616142651297](.image/image-20240616142651297.png)
...
![image-20240616143013207](.image/image-20240616143013207.png)

### Execute(branch comparator & PC + Immediate)

1. 首先执行Branch Comp，并将结果BrEq，BrLT传给Control Logic，用于控制PC到底去到哪里

![image-20240616142759066](.image/image-20240616142759066.png)

2. ALU执行PC + Immediate的操作，并将结果写回到到mux

![image-20240616143152316](.image/image-20240616143152316.png)

### update PC

1. 在接受了Branch Comp的结果之后，Control Logic会生成PCSel来选择是否进行跳转（也就是PC会更新为哪个值）

![image-20240616143316180](.image/image-20240616143316180.png)

2. 然后更新PC，实现跳转

![image-20240615144424975](.image/image-20240615144424975.png)
